...
// copied from https://github.com/joshackland/advent_of_code/blob/master/2024/go/day17.go
func main() {
	...
	defer Input.Close()
	input, _ := io.ReadAll(Input)
	day17_1(string(input))
	day17_2(string(input))
}
...
func day17_2(input string) {
	...
	_, B, C, program := parseRegisters(lines)
